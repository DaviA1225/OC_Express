 ...
 * parceiro (`termosDeUso('parceiro')`).
 *
 * Bloqueia o portal porque é condição de acesso, não aviso: quem não assume o
...
export function TermosDialog() {
  ...
  const termo = termosDeUso('parceiro')
        ...
        <DialogBody className="space-y-4">
          ...
          <div className="flex items-start gap-2 rounded-md border bg-muted/40 p-3">
            ...
            <Label htmlFor="concordo_termos" className="text-[13px] font-normal leading-relaxed">
              ...
              tratar os dados pessoais deste portal apenas para a operação contratada.
            </Label>
          </div>
        </DialogBody>
