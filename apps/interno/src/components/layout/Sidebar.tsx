      ...
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            ...
            isActive
              ? 'bg-primary/10 text-primary-strong before:absolute before:left-0 before:top-1/2 before:h-5 before:-translate-y-1/2 before:rounded-r-full before:bg-primary before:content-[""] ' +
